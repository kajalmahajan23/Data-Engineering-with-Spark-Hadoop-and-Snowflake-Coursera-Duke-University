...
"""
In this lab, we will work with the etl.py command-line tool to extract keywords from a text file and load them into a SQLite database. 
We will then query the database and customize the tool to return a specific number of results.
"""
